...
runSetList = ["Test.1.41", "Test.1.32", "Test.1.2", "Test.1.3", "Test.1.4", "Test.1.20", "Test.1.7", "Test.1.44", "Test.1.40", "Test.1.24"]
...
for runSetDir in runSetList:
    if os.path.isdir(rootDir + "\\" + runSetDir):
        ...
        for runDir in runList:
            if os.path.isdir(rootDir + "\\" + runSetDir + "\\" + runDir + "\\WestSide\\OutputFiles\\Rasters"):
                # extract zipped files
                outPath = rootDir + "\\" + runSetDir + "\\" + runDir + "\\WestSide\\OutputFiles\\Rasters"
